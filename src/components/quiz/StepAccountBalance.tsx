...
const texts = {
  ...
  en: {
    ...
    opts: [
      { label: "Less than R$100", sublabel: "That's okay — many started this way" },
      { label: "R$100 to R$500", sublabel: "That's enough to get started" },
      { label: "R$500 to R$2,000", sublabel: "Great starting point" },
      { label: "R$2,000 to R$10,000", sublabel: "Excellent — more options for you" },
      { label: "More than R$10,000", sublabel: "Maximum return potential" },
    ],
  ...
  es: {
    ...
    opts: [
      { label: "Menos de R$100", sublabel: "Está bien — muchos empezaron así" },
      { label: "Entre R$100 y R$500", sublabel: "Ya es suficiente para empezar" },
      { label: "Entre R$500 y R$2.000", sublabel: "Excelente punto de partida" },
      { label: "Entre R$2.000 y R$10.000", sublabel: "Excelente — más opciones para vos" },
      { label: "Más de R$10.000", sublabel: "Máximo potencial de retorno" },
    ],
