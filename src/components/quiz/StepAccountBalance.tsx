...
const texts = {
  ...
  en: {
    ...
    opts: [
      { label: "Less than $20", sublabel: "That's okay — many started this way" },
      { label: "$20 to $100", sublabel: "That's enough to get started" },
      { label: "$100 to $400", sublabel: "Great starting point" },
      { label: "$400 to $2,000", sublabel: "Excellent — more options for you" },
      { label: "More than $2,000", sublabel: "Maximum return potential" },
    ],
  ...
  es: {
    ...
    opts: [
      { label: "Menos de $20", sublabel: "Está bien — muchos empezaron así" },
      { label: "Entre $20 y $100", sublabel: "Ya es suficiente para empezar" },
      { label: "Entre $100 y $400", sublabel: "Excelente punto de partida" },
      { label: "Entre $400 y $2.000", sublabel: "Excelente — más opciones para vos" },
      { label: "Más de $2.000", sublabel: "Máximo potencial de retorno" },
    ],
