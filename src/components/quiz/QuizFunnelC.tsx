...
// ─────────────────────────────────────────────────────────────────────────
// QUIZ C — Edição paralela (teste A/B/C). Começa como cópia EXATA do Quiz A.
// As mudanças que você pedir (trocar alguns vídeos, etc.) são feitas AQUI —
// o Quiz A e o Quiz B não são tocados.
// ─────────────────────────────────────────────────────────────────────────
const QuizFunnelC = () => {
  ...
  const renderStep = () => {
    switch (currentSlug) {
      ...
      case "step-15":
        return <Step10Loading onNext={goNext} userAge={answers.age} userName={answers.name} photoSrc={logoGuardiao} />;
      case "step-16":
