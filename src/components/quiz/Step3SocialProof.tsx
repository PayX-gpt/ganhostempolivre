...
const texts = {
  ...
  en: {
    ...
    title2: " R$50 to R$300 per day. See who's already doing it.",
    ...
    youngTestimonial: "\"I used to work all day and at the end of the month there was never anything left. I started using it in my free time without quitting anything. Today I supplement my income with R$160 per day and can finally plan my future with peace of mind.\"",
    matureTestimonial: "\"I was embarrassed to borrow money every month. My pension didn't even cover basic bills. I started out scared, but the step-by-step process gave me confidence. Today I earn R$180 per day and don't depend on anyone anymore.\"",
  ...
  es: {
    ...
    title2: " R$50 a R$300 por día. Mirá quién ya lo está haciendo.",
    ...
    youngTestimonial: "\"Trabajaba todo el día y a fin de mes nunca me sobraba nada. Empecé a usarlo en mi tiempo libre, sin dejar nada. Hoy complemento mis ingresos con R$160 por día y finalmente puedo planificar mi futuro con tranquilidad.\"",
    matureTestimonial: "\"Me daba vergüenza pedir plata prestada todos los meses. Mi jubilación no cubría ni las cuentas básicas. Empecé con miedo, pero el paso a paso me dio seguridad. Hoy saco R$180 por día y no dependo de nadie más.\"",
...
const Step3SocialProof = ({ onNext, userAge }: Step3Props) => {
  ...
  useEffect(() => {
    ...
    if (iframe) {
      iframe.src = "https://scripts.converteai.net/09ec79a4-c31f-44ce-ba7d-89003424c826/players/67d187e9fad7e51c45b357f2/embed.html" + (window.location.search || "?") + "&vl=" + encodeURIComponent(window.location.href);
    }
    ...
    <StepContainer>
      ...
      <div className="w-full rounded-2xl overflow-hidden border border-border scroll-mt-24" ref={videoRef}>
        <div id="ifr_67d187e9fad7e51c45b357f2_wrapper" style={{ margin: "0 auto", width: "100%" }}>
          <div style={{ padding: "56.25% 0 0 0", position: "relative" }} id="ifr_67d187e9fad7e51c45b357f2_aspect">
            <iframe frameBorder="0" allowFullScreen src="about:blank" id="ifr_67d187e9fad7e51c45b357f2" style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }} referrerPolicy="origin" />
          </div>
        </div>
      </div>
      ...
      <div className="w-full funnel-card border-primary/25 bg-primary/5">
        <div className="flex items-center gap-3 mb-3">
          <img src={young ? avatarRafael : avatarRegina} alt={young ? t.youngName : t.matureName} className="w-11 h-11 sm:w-12 sm:h-12 rounded-full object-cover border-2 border-primary/30 shrink-0" />
          <div className="min-w-0">
            <p className="font-bold text-foreground text-sm sm:text-base">{young ? t.youngName : t.matureName}</p>
            <div className="flex items-center gap-1">
              <span className="text-xs sm:text-sm text-muted-foreground">{young ? t.youngLoc : t.matureLoc} • {t.verified}</span>
