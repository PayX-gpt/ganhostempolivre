...
const texts = {
  ...
  en: {
    ...
    title2: " $10 to $60 per day. See who's already doing it.",
    ...
    youngTestimonial: "\"I used to work all day and at the end of the month there was never anything left. I started using it in my free time without quitting anything. Today I supplement my income with $32 per day and can finally plan my future with peace of mind.\"",
    matureTestimonial: "\"I was embarrassed to borrow money every month. My pension didn't even cover basic bills. I started out scared, but the step-by-step process gave me confidence. Today I earn $36 per day and don't depend on anyone anymore.\"",
  ...
  es: {
    ...
    title2: " $10 a $60 por día. Mirá quién ya lo está haciendo.",
    ...
    youngTestimonial: "\"Trabajaba todo el día y a fin de mes nunca me sobraba nada. Empecé a usarlo en mi tiempo libre, sin dejar nada. Hoy complemento mis ingresos con $32 por día y finalmente puedo planificar mi futuro con tranquilidad.\"",
    matureTestimonial: "\"Me daba vergüenza pedir plata prestada todos los meses. Mi jubilación no cubría ni las cuentas básicas. Empecé con miedo, pero el paso a paso me dio seguridad. Hoy saco $36 por día y no dependo de nadie más.\"",
