...
const texts = {
  ...
  en: {
    ...
    headlineYoung: <>Get ready! In just <span className="text-accent">30 SECONDS</span>, I'll show you how to generate <span className="text-gradient-green">$40 to $200</span> in extra income, dedicating only <span className="text-accent">10 MINUTES OF YOUR DAY</span>!</>,
    headlineMature: <>In the next <span className="text-accent">30 SECONDS</span> I'll explain how to earn with just <span className="text-accent">10 MIN OF YOUR FREE TIME</span> from <span className="text-gradient-green">$40 to $200</span>!</>,
    cta: "GET MY ACCESS →",
    watchToUnlock: "Watch the video to continue...",
    youngTestimonials: [
      { name: "Rafael, 29", loc: "SP", text: "I started dedicating 15 minutes a day. By the third day I had already made $18. Now it's part of my monthly income." },
      { name: "Camila, 32", loc: "RJ", text: "I supplement with $28 per day and can finally invest in my future. The support is excellent." },
    ],
    matureTestimonials: [
      { name: "Antônio, 45", loc: "SP", text: "I started slowly and by the third day I had already made $17. Today I pay my bills with peace of mind." },
      { name: "Cláudia, 53", loc: "MG", text: "I supplement with $30 per day and finally sleep without worry. Support helped at every step." },
    ],
  ...
  es: {
    ...
    headlineYoung: <>¡Preparate! En solo <span className="text-accent">30 SEGUNDOS</span>, te voy a mostrar cómo generar de <span className="text-gradient-green">$40 a $200</span> de ingreso extra, dedicando solo <span className="text-accent">10 MINUTOS DE TU DÍA</span>!</>,
    headlineMature: <>En los próximos <span className="text-accent">30 SEGUNDOS</span> te voy a explicar cómo ganar con solo <span className="text-accent">10 MIN DE TU TIEMPO LIBRE</span> de <span className="text-gradient-green">$40 a $200</span>!</>,
    cta: "OBTENER MI ACCESO →",
    watchToUnlock: "Mirá el video para continuar...",
    youngTestimonials: [
      { name: "Rafael, 29", loc: "SP", text: "Empecé dedicando 15 minutos por día. Al tercer día ya había ganado $18. Hoy es parte de mi ingreso mensual." },
      { name: "Camila, 32", loc: "RJ", text: "Complemento con $28 por día y finalmente puedo invertir en mi futuro. El soporte es excelente." },
    ],
    matureTestimonials: [
      { name: "Antônio, 45", loc: "SP", text: "Empecé despacio y al tercer día ya había ganado $17. Hoy pago mis cuentas con tranquilidad." },
      { name: "Cláudia, 53", loc: "MG", text: "Complemento con $30 por día y finalmente duermo sin preocupación. El soporte me ayudó en cada paso." },
    ],
