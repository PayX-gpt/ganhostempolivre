...
const UpsellStep6 = () => {
  ...
  if (boughtAccel) {
    subtitle = `Seu Acelerador ${accelNames[choice.accelerator!]} foi ativado com sucesso. Seus primeiros resultados devem aparecer em até ${accelTimes[choice.accelerator!]}. Fique de olho no seu WhatsApp — nosso suporte vai entrar em contato em instantes.`;
  } else if (boughtGuide) {
    subtitle = "Seu Guia Primeiros Passos foi liberado. Você vai receber o acesso no seu e-mail em até 5 minutos. Siga o passo a passo e em 7 dias você estará gerando seus primeiros resultados.";
  }
  ...
  return (
    <UpsellLayout progress={100}>
      ...
      <div className="flex flex-col items-center gap-5 pt-8">
        ...
        <h1 className="text-[26px] font-bold text-center" style={{ color: "#F8FAFC" }}>
          Tudo pronto, {name}! 🚀
        </h1>
        ...
        <p className="text-xs pb-6" style={{ color: "#64748B" }}>
          Qualquer dúvida, nosso suporte está disponível 24h pelo WhatsApp.
        </p>
      </div>
    </UpsellLayout>
  );
