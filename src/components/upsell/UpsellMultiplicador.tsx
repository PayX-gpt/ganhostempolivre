...
const plans = [
  {
    ...
    multFactor: 5,
    dailyBonus: 125,
    description: "Seus juros compostos passam a operar 5x mais rápido, desbloqueando um novo limite diário de R$ 125. É como trocar da 1ª marcha pra 3ª — mais velocidade com segurança.",
    price: 47,
